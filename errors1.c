 ...
 * @estr: The string with specified error type
 * Return: 0 if no numbers in string, otherwise converted number
 * 	-1 for error
 */
...
/**
 * print_d - function diplays a decimal number
 * @input: input
...
/**
 * convert_number -  function for converting, clone of itoa
 * @num: the number
...
/**
 * remove_comments - function alters first instance of '#' with '\0'
