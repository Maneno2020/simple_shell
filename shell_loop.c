 ...
 *
 * Return: 0 for success, 1 otherwise, else error code
 */
 ...
 *         0 if the builtin successfully executed,
...
/**
 * fork_cmd - creates an exec thread for running cmd
 * @info: parameter and display info structure
 *
 * Return: void
 */
