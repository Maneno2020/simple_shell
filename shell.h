 ...
 * @status: the pront status of the last exec'd command
 * @cmd_buf: reference of ptr to cmd_buf, on if chaining
...
/**
 * struct builtin - with a builtin string and related function
